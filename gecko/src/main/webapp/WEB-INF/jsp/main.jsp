...
<div class="container">
                ...
                <c:forEach items="${result}" var="member">
                    <tr>
                        ...
                        <td><input type="button" value="Update" onclick="" class="btn btn-warning btn-sm">
                            <input type="button" value="Delete" onclick="delMember('${member.regno}');"
    ...
    <input type="button" class="btn btn-success btn-sm"
           onclick="javascript:location.href='${pageContext.request.contextPath}/registerForm.do'"
           value="Insert (File Upload)">

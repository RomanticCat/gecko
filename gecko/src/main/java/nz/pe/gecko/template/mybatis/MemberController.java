...
public class MemberController {
	...
	@RequestMapping(value = "/getMemListJSON.do", method = RequestMethod.GET, produces=MediaType.APPLICATION_JSON_VALUE)
	 */
	@ResponseBody
	@RequestMapping(value = "/getMemListJSON.do", method = RequestMethod.GET, produces={"application/json;charset=UTF-8"})
